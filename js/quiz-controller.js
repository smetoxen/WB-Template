...
var quizjson="quiz.json";
		...
		<!--This block of code allows you to have more than one quiz in your website. If you have more than three quizzes, add more "else if" statements. The "quizjson" variable sets the name of the json file where you keep your quiz content. -->
		/*
