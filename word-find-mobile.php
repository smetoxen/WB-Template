...
<div class = "wrapper" style="width:100%">
  	<img src="images/webbanner.png" style="max-width:1200px;width:100%;height:auto;margin-left:auto;margin-right:auto;margin-top:-50px;margin-bottom:0px;display:block;box-shadow:none" />
  

	<div class="content" style="margin-left:auto;margin-right:auto;display:block;width:100%">

          <a href="index.php" style="font-size:1.3em">Home</a> | 
          <a href="mailto:?subject=Try this fun Word Find about Agates&amp;body=Check out this word find that is all about Lake Superior Agates! http://www.IsThisAnAgate.com/wordfind.php." title="Share by Email" style="font-size:1.3em">Share with a Friend</a>


			            <img src="images/Minnesota.jpg" style="max-width:267px; width:30%; height:auto;float:left;margin:20px">
