...
<div id="myCarousel-1" class="carousel slide" data-ride="carousel" data-interval="false"  style="max-width:700px;margin:20px auto">
          ...
          <div class="carousel-inner" style="max-width:700px">
              <div class="item active">
              		<a href="http://castonengineering.com/projects.php" target="_blank"><img src="images/portfolio/WebPortfolio.001.jpg" class="portfolio" width="100%" height="auto"  alt="Is this an agate website" /></a></div>
        ...
        </div><!--end carousol inner-->
     
      <a class="left carousel-control" style="background-color:none !important;" href="#myCarousel-1" role="button" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a>
      <a class="right carousel-control" href="#myCarousel-1" role="button" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
    </div><!-- /.carousel -->
