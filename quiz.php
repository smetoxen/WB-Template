   ...
   <?php require_once "nav.php" ?>
    ...
    <div class="container-fluid">
      ...
      <div class="row">
       ...
       <br>
          <div class="col-md-9">
       		<div id="topbar"><h2 style="text-align:center">Fun Numbers Quiz<br><span class="glyphicon glyphicon-star"><span class="glyphicon glyphicon-star"></span><span class="glyphicon glyphicon-star"></span></span></h2></div>
