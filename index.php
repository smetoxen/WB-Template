  ...
  <div class="content">
    ...
    <div class="container-fluid"> 
      ...
      <div class="row">
        ...
        <div class="col-md-3"> <a href="quiz.php">
        ...
        <div class="col-md-3"> <a href="picture-quiz.php">
          <h3>Picture Quiz</h3>
          </a>
        ...
        <div class="col-md-3"> <a href="puzzle.php">
          <h3>Puzzle</h3>
          </a>
        ...
        <div class="col-md-3"> <a href="word-find.php">
          <h3>Word Find</h3>
          </a>
